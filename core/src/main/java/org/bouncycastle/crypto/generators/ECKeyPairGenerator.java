    ...
    implements AsymmetricCipherKeyPairGenerator, ECConstants
{
    ...
    {
        System.out.println("[ECKeyPairGenerator.init]");
        ECKeyGenerationParameters  ecP = (ECKeyGenerationParameters)param;
        System.out.println("strength: " + ecP.getStrength());
    ...
    {
        System.out.println("[ECKeyPairGenerator.generateKeyPair]");
        ...
        System.out.println("params: \n" + params.getDetailInfo());
        System.out.printf("nBitLength=%d, minWeight=%d\n", nBitLength, minWeight);
        System.out.println("d: " + Hex.toHexString(d.toByteArray()));
        System.out.println("Q no compressed: " + Hex.toHexString(Q.getEncoded(false)));
        System.out.println("Q compressed: " + Hex.toHexString(Q.getEncoded(true)));
