    ...
    protected DHKEM(short kemid)
    {
        ...
        case HPKE.kem_P256_SHA256:
            ...
            domainParams = new ECDomainParameters(
                curve,
                curve.createPoint(
                    new BigInteger(1, Hex.decode("60F0551D75055EE2F028857A4642154BB3F1B5181A0E6CA0C075A87982942526")),
                    new BigInteger(1, Hex.decode("30122FFD36A534B85AEB18C91636DD2FB49770891C181C2F014C406DC25BE73A"))
                ),
                curve.getOrder(),
                curve.getCofactor(),
