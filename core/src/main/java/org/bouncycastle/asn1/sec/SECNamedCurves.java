...
public class SECNamedCurves
{
    ...
    static X9ECParametersHolder secp256r1 = new X9ECParametersHolder()
    {
        protected ECCurve createCurve()
        {
            ...
            /******************* [SAGE MATH] ******************
                P = 0xBD360F61FFE6CCAE602D68B553A69F2A61788699CA0EF78B5213A3E451BAFF0F
                A = 0x3FFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC
                B = 0x3AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B
                print((-16 * (4 * A * A * A + 27 * B * B) % P), P.is_prime())
                E = EllipticCurve(FiniteField(P), [A, B])
                n_points = E.cardinality()
                print("n_points:", n_points, ", order:", E.order(), P > n_points)
                G = E(0x60F0551D75055EE2F028857A4642154BB3F1B5181A0E6CA0C075A87982942526, 0x8D23DF64C94197F605424FEC3D6FC1FAACE11610ADF6DB5C50C763768F5F17D5)
                print("g_order: ", G.order())
                print(n_points / G.order(), n_points % G.order())
            */
            BigInteger p = fromHex("BD360F61FFE6CCAE602D68B553A69F2A61788699CA0EF78B5213A3E451BAFF0F");
            BigInteger a = fromHex("3FFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC");
            BigInteger b = fromHex("3AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B");
            BigInteger n = fromHex("BD360F61FFE6CCAE602D68B553A69F2A0D0F76A56C05A8A05B500F08D6243326");
            BigInteger h = BigInteger.valueOf(1);
        ...
        protected X9ECParameters createParameters()
        {
            ...
            X9ECPoint G = configureBasepoint(curve,
                "0460F0551D75055EE2F028857A4642154BB3F1B5181A0E6CA0C075A8798294252630122FFD36A534B85AEB18C91636DD2FB49770891C181C2F014C406DC25BE73A");
