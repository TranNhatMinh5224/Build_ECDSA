...
public class X962NamedCurves
{
    ...
    static X9ECParametersHolder prime256v1 = new X9ECParametersHolder()
    {
        protected ECCurve createCurve()
        {
            ...
            return configureCurve(new ECCurve.Fp(
                new BigInteger("85582644291994988525887681162223197197626326817200095305631944482267426651919"),
                fromHex("3FFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC"),
                fromHex("3AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B"),
                n, h, true));
        }
        ...
        protected X9ECParameters createParameters()
        {
            ...
            X9ECPoint G = configureBasepoint(curve,
                "0360F0551D75055EE2F028857A4642154BB3F1B5181A0E6CA0C075A87982942526");
