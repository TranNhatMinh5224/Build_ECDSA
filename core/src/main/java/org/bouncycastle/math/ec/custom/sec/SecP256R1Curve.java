...
public class SecP256R1Curve extends ECCurve.AbstractFp
{
    ...
    public SecP256R1Curve()
    {
        ...
        this.a = fromBigInteger(new BigInteger(1,
            Hex.decodeStrict("3FFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC")));
        this.b = fromBigInteger(new BigInteger(1,
            Hex.decodeStrict("3AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B")));
        this.order = new BigInteger(1, Hex.decodeStrict("BD360F61FFE6CCAE602D68B553A69F2A0D0F76A56C05A8A05B500F08D6243326"));
