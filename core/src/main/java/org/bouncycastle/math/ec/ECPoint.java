...
public abstract class ECPoint
{
    ...
    public static abstract class AbstractFp extends ECPoint
    {
        ...
        protected boolean satisfiesCurveEquation()
        {
            ...
            //     System.out.println("[X]: " + Hex.toHexString(X.toBigInteger().toByteArray()));
            //     System.out.println("[Y]: " + Hex.toHexString(Y.toBigInteger().toByteArray()));
            //     System.out.println("[A]: " + Hex.toHexString(A.toBigInteger().toByteArray()));
            //     System.out.println("[B]: " + Hex.toHexString(B.toBigInteger().toByteArray()));
            //     System.out.println("[lhs]: " + Hex.toHexString(lhs.toBigInteger().toByteArray()) + ", " + "[rhs]: " + Hex.toHexString(rhs.toBigInteger().toByteArray()));
            // }
